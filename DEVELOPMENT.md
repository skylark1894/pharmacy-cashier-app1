...
```bash
git remote add encore encore://pharmacy-cashier-app-tuq2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/pharmacy-cashier-app-tuq2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/pharmacy-cashier-app-tuq2/settings/integrations/github)
